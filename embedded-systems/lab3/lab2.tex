...
\fancyhead[C]{System przerwań}
\fancyhead[R]{Labolatorium 2}
...
\lstinputlisting[language=C, caption=Program zadanie 2.2]{code/lab2/lab2.c}

\begin{thebibliography}{99}
\bibitem{skr} Instrukcja do ćwiczeń laboratoryjnych
